...
vunit_lib.add_source_files(join(root, "tb_pred_ctrl_local_diff.vhd"))
...
def gen_pred_ctrl_ldiff_tests(obj, smpl_order, predict_mode):
    for smpl_order, predict_mode in product(smpl_order, predict_mode):
        tb_cfg = dict(
