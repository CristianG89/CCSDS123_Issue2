...
vunit_lib.add_source_files(join(root, "tb_local_sum.vhd"))
...
def gen_local_sum_tests(obj, smpl_order, lsum_type):
    for smpl_order, lsum_type in product(smpl_order, lsum_type):
        tb_cfg = dict(
