...
vunit_lib.add_source_files(join(root, "tb_top_prediction.vhd"))
...
def gen_prediction_tests(obj, smpl_order, lsum_type, predict_mode, w_init_type):
    for smpl_order, lsum_type, predict_mode, w_init_type in product(smpl_order, lsum_type, predict_mode, w_init_type):
        tb_cfg = dict(
